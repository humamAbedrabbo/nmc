    ...
    public class MedContext : IdentityDbContext<AppUser, AppRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Department>().HasData(
                new Department { Id = 1, DepartmentType = DepartmentType.Administrtion, Name = "Administration", NameAr = "الادارة" },
                new Department { Id = 2, DepartmentType = DepartmentType.Administrtion, Name = "Financial and Accounting Department ", NameAr = "الإدارة المالية و قسم المحاسبة" },
                new Department { Id = 3, DepartmentType = DepartmentType.Ward, Name = "Pediatric Department -  Incubators section (NICU)", NameAr = "جناح الأطفال - قسم الحواضن" },
                new Department { Id = 4, DepartmentType = DepartmentType.Ward, Name = "Internal Medicine", NameAr = "قسم الداخلية الباطنية" },
                new Department { Id = 5, DepartmentType = DepartmentType.Ward, Name = "Intensive Care Unite (ICU)", NameAr = "قسم العناية المشددة" },
                new Department { Id = 6, DepartmentType = DepartmentType.Ward, Name = "Obstetric & Genecology", NameAr = "جناح النسائية والمخاض" },
                new Department { Id = 7, DepartmentType = DepartmentType.Ward, Name = "Dialysis", NameAr = "قسم غسيل الكلى" },
                new Department { Id = 8, DepartmentType = DepartmentType.Ward, Name = "Arthroscopy", NameAr = "قسم التنظير" },
                new Department { Id = 9, DepartmentType = DepartmentType.Laboratory, Name = "Cath Lab - Cardiovascular (CCU)", NameAr = "قسم العناية القلبة والقثطرة القلبية" },
                new Department { Id = 10, DepartmentType = DepartmentType.Ward, Name = "Blood vessels", NameAr = "قسم الأوعية" },
                new Department { Id = 11, DepartmentType = DepartmentType.Ward, Name = "Urology", NameAr = "قسم البولية" },
                new Department { Id = 12, DepartmentType = DepartmentType.Ward, Name = "Respiratory System Diseases", NameAr = "أمراض الجهاز التنفسي" },
                new Department { Id = 13, DepartmentType = DepartmentType.Administrtion, Name = "Catering section", NameAr = "قسم الإطعام" },
                new Department { Id = 14, DepartmentType = DepartmentType.Ward, Name = "Emergency (ER)", NameAr = "قسم الإسعاف والطوارئ" },
                new Department { Id = 15, DepartmentType = DepartmentType.Administrtion, Name = "Maintenance Department", NameAr = "قسم الصيانة" },
                new Department { Id = 16, DepartmentType = DepartmentType.Laboratory, Name = "Laboratory", NameAr = "المخبر" },
                new Department { Id = 17, DepartmentType = DepartmentType.Laboratory, Name = "Radiography", NameAr = "قسم التصوير الشعاعي" },
                new Department { Id = 18, DepartmentType = DepartmentType.Administrtion, Name = "Medical warehouse", NameAr = "المستودع الطبي" },
                new Department { Id = 19, DepartmentType = DepartmentType.Administrtion, Name = "Pharmacy", NameAr = "الصيدلية" },
                new Department { Id = 20, DepartmentType = DepartmentType.Ward, Name = "Operation Rooms (OR)", NameAr = "جناح العمليات" }
                );
            ...
            var rooms = new[]
            {
                new Room { Id = 1, WardId = 3, FloorNo = 1, RoomNo = "11", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 2, WardId = 3, FloorNo = 1, RoomNo = "12", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 3, WardId = 3, FloorNo = 1, RoomNo = "13", BedCount = 1, RoomTypeId = 1, RoomGradeId = 2  },
                new Room { Id = 4, WardId = 3, FloorNo = 1, RoomNo = "14", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 5, WardId = 3, FloorNo = 1, RoomNo = "15", BedCount = 1, RoomTypeId = 1, RoomGradeId = 2  },
                new Room { Id = 6, WardId = 3, FloorNo = 1, RoomNo = "16", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 7, WardId = 3, FloorNo = 1, RoomNo = "17", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 8, WardId = 3, FloorNo = 1, RoomNo = "18", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 9, WardId = 3, FloorNo = 1, RoomNo = "19", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 10, WardId = 4, FloorNo = 2, RoomNo = "21", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 11, WardId = 4, FloorNo = 2, RoomNo = "22", BedCount = 1, RoomTypeId = 1, RoomGradeId = 2  },
                new Room { Id = 12, WardId = 4, FloorNo = 2, RoomNo = "23", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 13, WardId = 4, FloorNo = 2, RoomNo = "24", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 14, WardId = 4, FloorNo = 2, RoomNo = "25", BedCount = 1, RoomTypeId = 1, RoomGradeId = 2  },
                new Room { Id = 15, WardId = 4, FloorNo = 2, RoomNo = "26", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 16, WardId = 4, FloorNo = 2, RoomNo = "27", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 17, WardId = 4, FloorNo = 2, RoomNo = "28", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 18, WardId = 4, FloorNo = 2, RoomNo = "29", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 19, WardId = 5, FloorNo = 3, RoomNo = "31", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 20, WardId = 5, FloorNo = 3, RoomNo = "32", BedCount = 1, RoomTypeId = 1, RoomGradeId = 3  },
                new Room { Id = 21, WardId = 5, FloorNo = 3, RoomNo = "33", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 22, WardId = 5, FloorNo = 3, RoomNo = "34", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 23, WardId = 5, FloorNo = 3, RoomNo = "35", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 24, WardId = 5, FloorNo = 3, RoomNo = "36", BedCount = 1, RoomTypeId = 1, RoomGradeId = 3  },
                new Room { Id = 25, WardId = 5, FloorNo = 3, RoomNo = "37", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 26, WardId = 5, FloorNo = 3, RoomNo = "38", BedCount = 1, RoomTypeId = 1, RoomGradeId = 1  },
                new Room { Id = 27, WardId = 5, FloorNo = 3, RoomNo = "39", BedCount = 1, RoomTypeId = 1, RoomGradeId = 2  },
            };
